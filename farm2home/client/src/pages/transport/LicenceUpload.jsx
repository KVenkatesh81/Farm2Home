    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-xl border border-gray-200 p-10 max-w-md text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">Your licence is under review. You'll get access once verified by our team. This usually takes 24 hours.</p>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-xl border border-gray-200 p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            <label className="text-sm text-gray-600 mb-1 block">Licence image</label>
